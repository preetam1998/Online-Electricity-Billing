...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        /* First Column */
        JMenu Amaster = new JMenu("Master");
        JMenuItem m1 = new JMenuItem("New Customer");
        JMenuItem m2 = new JMenuItem("View Details");
        JMenuItem m3 = new JMenuItem("Calculate Bill");
        Amaster.setForeground(Color.BLUE);
        ...
        m3.setIcon(new ImageIcon(image5));
        m3.setMnemonic('B');
        ...
        /* Second Column */
        JMenu Uinfo = new JMenu("Information");
        JMenuItem info1 = new JMenuItem("Update Information");
        JMenuItem info2 = new JMenuItem("View Information");
        JMenuItem info3 = new JMenuItem("Deposit Details");
        Uinfo.setForeground(Color.RED);
        ...
        info3.setIcon(new ImageIcon(image3));
        info3.setMnemonic('N');
        info3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));
        ...
        /* Second Column */
        JMenu Uuser = new JMenu("User");
        JMenuItem u1 = new JMenuItem("Pay Bill");
        JMenuItem u3 = new JMenuItem("Bill Details");
        Uuser.setForeground(Color.RED);
        ...
        /* Third Column*/
        JMenu Areport = new JMenu("Report");
        JMenuItem r1 = new JMenuItem("Generate Bill");
        JMenuItem r2 = new JMenuItem("Meter Info");
        JMenuItem r3 = new JMenuItem("Last Bill");
        Areport.setForeground(Color.BLUE);
        ...
        // --One more column for generate-----------------------------------------------------------------------------------
        /* Third Column*/
        JMenu Agenerate = new JMenu("Generate");
        JMenuItem g1 = new JMenuItem("Generate Bill");
        
        Agenerate.setForeground(Color.BLUE);
        
        /* ---- Report ---- */
        g1.setFont(new Font("monospaced",Font.PLAIN,12));
        g1.setMnemonic('G');
        g1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("View Details")){
            ...
            new DepositDetails(meter).setVisible(true);
